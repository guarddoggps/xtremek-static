<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Geofence.aspx.cs" Inherits="Map_Geofence" %>
...
<script type="text/javascript" language="JavaScript">
        ...
        var singleClick = false;
               ...
               function btnMove(leftbox,rightbox)
                {
            ...
            function _setHiddenValue()
            {
                ...
                var selectedList = document.getElementById("_lstBT");
         ...
         function loadControls()
         {
            ...
            {               
                ...
                myMap.setCenter(new GLatLng(43.907787,-79.359741),4,G_HYBRID_MAP);
            ...
            else
            {
                myMap.addControl(new GSmallMapControl());
                myMap.addControl(new GMapTypeControl());
                myMap.setCenter(new GLatLng(_Lat.value,_Long.value),5,G_HYBRID_MAP);
                GEvent.addListener(myMap,'click',clickedMap);
...
//                        var km2Mile=rd.value/1.60934;
         ...
         {
            if(sender._postBackSettings.panelID=="updateMap|btnClear")    
            {
                clearCircle(); 
            }
...
<body class="szbody" onload="loadControls();">
    ...
    <asp:ScriptManager runat="server" ID="Manager" AsyncPostBackTimeout="300"></asp:ScriptManager>
    <div>
        <script type="text/javascript">
            ...
            GeoQuery.prototype.initializeCircle = function(radius, point, map) {
                ...
                GEvent.addListener(this._centerHandle, "drag", function() {myObject.updateCircle(2);});
                   ...
                   var Latitude = document.getElementById('<%= _Lat.ClientID %>');
                   var Longitude = document.getElementById('<%= _Long.ClientID %>');
            ...
            GeoQuery.prototype.updateCircle = function (type) {
                ...
                if (type==1) {
                  ...
                  var Latitude = document.getElementById('<%= _Lat.ClientID %>');
                  var Longitude = document.getElementById('<%= _Long.ClientID %>');
                  Latitude.value = this._centerHandlePosition.lat();
                  Longitude.value= this._centerHandlePosition.lng();
         ...
         <div class="cell_label01" >
               <div id="div1">
                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                        ...
                        <div class="radiobutton">
                            <asp:RadioButton GroupName="Unit" AutoPostBack="true" runat="server" ID="_rdUnitGroup" 
                                Checked="true" oncheckedchanged="_rdUnitGroup_CheckedChanged" />
                        </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>                        
               </div>
               ...
               <div id="div2">
                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                        <ContentTemplate>
                        <div class="radiobutton">
                            <asp:RadioButton ID="_rdUnits" AutoPostBack="true" runat="server" GroupName="Unit" 
                                oncheckedchanged="_rdUnits_CheckedChanged" />
                        </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
               </div>
           ...
           <div class="container_01">
              <div class="aligment">
                 <div class="formlistbox_a">
                        <asp:UpdatePanel ID="UpdatePanelNList"  runat="server" UpdateMode="Conditional">
                         <ContentTemplate> 
                                   <asp:ListBox CssClass="formlistbox_d" ID="_lstNBT" 
                                       SelectionMode="Multiple"   				   			   runat="server" Width="161px"></asp:ListBox>                                
                         </ContentTemplate>
                      </asp:UpdatePanel>                    
                 </div>   
                 <div class="formlistbox_b">
                        <asp:UpdatePanel ID="id01" runat="server">
                            <ContentTemplate>
                                 <asp:Button ID="Btn0" runat="server" CssClass="form_AddBtn" 
                                     OnClientClick="btnMove('_lstNBT','_lstBT'); return false;" Text=">>" 
                                     Width="18px" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                        <br />
                        <asp:UpdatePanel ID="id02" runat="server">
                            <ContentTemplate>
                                <asp:Button ID="_btn1" runat="server" CssClass="form_AddBtn" OnClientClick="btnMove('_lstBT','_lstNBT'); return false;" Text="<<" />
                            </ContentTemplate>
                        </asp:UpdatePanel>                
                 </div>
                 <div class="formlistbox_c">
                            <asp:UpdatePanel ID="addList" UpdateMode="Conditional" runat="server">
                                <ContentTemplate>                             
                                        <asp:ListBox CssClass="formlistbox_d" ID="_lstBT" SelectionMode="Multiple"   
                                            runat="server" Width="161px"></asp:ListBox>
                                </ContentTemplate>
                            </asp:UpdatePanel>                      
                 </div>
                  </div>        
    ...
    <div class="container_01">
      ...
      <div class="container_01">
        <div class="container_02">
          ...
          <div class="cell_label01" >
               <div id="divCircular">
                    <asp:UpdatePanel ID="updateCurcular" runat="server">
                        <ContentTemplate>
                        <div class="radiobutton">
                            <asp:RadioButton GroupName="geofence" runat="server" ID="_rdoCircular" Checked="true" />
                        </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>                        
               </div>
               ...
               <div id="divHighway">
                    <asp:UpdatePanel ID="updateHighway" runat="server">
                        <ContentTemplate>
                        <div class="radiobutton">
                            <asp:RadioButton ID="_rdoHighway" runat="server" GroupName="geofence" />
                        </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
               </div>
   ...
   <div class="container_01">
        ...
        <div class="szcol01">
                Directions:<br />
                1. Move cursor at  desired point in map<br />
                2. Single click on map safety zone will appear<br />
                3. Drag "size ring" with your cursor to desired size of safety zone<br />
   ...
   <div class="container_01">
     <div class="container_02">
      ...
      <div id="divCancel" class="alertbutton01">
            <asp:Button ID="_btnCancel" CssClass="formSubmitBtn" runat="server" Text="Cancel" OnClick="_btnCancel_Click" OnClientClick="CloseOnReload()"/>
      </div>       
     </div>
   </div>
